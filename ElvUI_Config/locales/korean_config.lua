...
L["Setup on-screen display of information bars."] = "화면에 표시되는 각종 정보 바들을 설정합니다."
...
L["Reverse Fill Direction"] = "채우기 방향 반대로"
...
L["Remove Spell ID or Name"] = "주문ID 또는 이름 삭제"
...
L["Statusbar Fill Orientation"] = "상태막대 채우기 방향"
