...
L["Display the rested icon on the unitframe."] = "Afficher l'icône reposée sur les cadres d'unité"
...
L["Don't display any auras found on the 'Blacklist' filter."] = "Ne pas afficher les auras trouvées dans la 'Liste noire' du filtre."
...
L["Don't display auras that cannot be purged or dispelled by your class."] = "Ne pas afficher les auras qui ne peuvent pas être purgées ou dissipées par votre classe." 
...
L["If no other filter options are being used then it will block anything not on the 'Whitelist' filter, otherwise it will simply add auras on the whitelist in addition to any other filter settings."] = "S'il n'y a pas d'autres options de filtres utilisées, il masquera les éléments non présent sur la 'Liste Blanche' du filtre. Sinon il suffira d'y ajouter les auras, en plus des autres paramètres du filtre."
