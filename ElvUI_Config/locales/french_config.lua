...
L["Bring to front on low health"] = "Faire clignoter la police sur la vie faible"
...
L["Color By Raid Icon"] = "Colorer par l'icône de Raid";
L["Color Name By Health Value"] = "Colorer le nom selon le niveau de vie"
L["Color on low health"] = "Colorer si le niveau de vie est faible"
...
L["Controls the height of the nameplate on low health"] = "Contrôle la hauteur du cadre d'unité si le niveau de vie est faible"
L["Controls the height of the nameplate"] = "Contrôle la hauteur de la barre des cadres d'unités"
L["Controls the width of the nameplate on low health"] = "Contrôle la largeur du cadre d'unité si le niveau de vie est faible"
