...
L["This makes the item level display more reliable but uses more resources. If this is disabled then upgraded items will not show the correct item level."] = "Делает отображение уровня предметов точнее, но потребляет больше ресурсов. При отключении может неверно отображаться уровень улучшенных предметов."
...
L["Disable OrderHall Bar"] = "Отключить полосу оплота класса"
...
L["Number Prefix"] = "Префиксы значений"
