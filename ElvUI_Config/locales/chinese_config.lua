...
L["Color of the actionbutton when not usable."] = "雿銝."
...
L["Color of the actionbutton when usable."] = "雿."
...
L["Full"] = "满"
L["Global"] = "全局"
L["Here you can add items or search terms that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "雿隞亙餈溶葉祗瘜.閬宏銝銝芰閬”銝剔隞賑."
...
L["Controls which nameplates will be displayed."] = "雿鋡急蝷"
