...
local UNIT_NAMEPLATES_TYPE_1, UNIT_NAMEPLATES_TYPE_2, UNIT_NAMEPLATES_TYPE_3 = UNIT_NAMEPLATES_TYPE_1, UNIT_NAMEPLATES_TYPE_2, UNIT_NAMEPLATES_TYPE_3
				...
				general = {
					...
					args = {
						...
						motionType = {
							...
							values = {
								["SPREADING"] = UNIT_NAMEPLATES_TYPE_3,
