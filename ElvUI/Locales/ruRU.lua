...
L["Lock"] = "Закрепить"
L["LOGIN_MSG"] = "Добро пожаловать в %sElvUI|r версии %s%s|r, наберите /ec для доступа в меню настроек. Если Вам нужна техническая поддержка, посетите наш форум на https://github.com/ElvUI-Cataclysm или присоединяйтесь к серверу Discord: https://discord.gg/AdrA9ZQ"
