	...
	if db.aurabar.enable then
		...
		if not auraBars.Holder then
			...
			if frame.unitframeType == "player" then
				E:CreateMover(holder, "ElvUF_PlayerAuraMover", L["Player Aura Bars"], nil, nil, nil, "ALL,SOLO", nil, "unitframe,player,aurabar")
			elseif frame.unitframeType == "target" then
				E:CreateMover(holder, "ElvUF_TargetAuraMover", L["Target Aura Bars"], nil, nil, nil, "ALL,SOLO", nil, "unitframe,target,aurabar")
			elseif frame.unitframeType == "pet" then
				E:CreateMover(holder, "ElvUF_PetAuraMover", L["Focus Aura Bars"], nil, nil, nil, "ALL,SOLO", nil, "unitframe,pet,aurabar")
			elseif frame.unitframeType == "focus" then
				E:CreateMover(holder, "ElvUF_FocusAuraMover", L["Pet Aura Bars"], nil, nil, nil, "ALL,SOLO", nil, "unitframe,focus,aurabar")
			end
