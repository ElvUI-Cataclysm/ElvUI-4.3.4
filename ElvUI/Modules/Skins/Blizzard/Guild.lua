...
local function LoadSkin()
	...
	GuildInfoFrameInfoHeader1.bg:Point("TOPLEFT", 4, -24)
	GuildInfoFrameInfoHeader1.bg:Point("BOTTOMRIGHT", -3, 199)

	S:HandleButtonHighlight(GuildInfoChallengesDungeon)
	S:HandleButtonHighlight(GuildInfoChallengesRaid)
	S:HandleButtonHighlight(GuildInfoChallengesRatedBG)
	...
	S:HandleScrollBar(GuildInfoFrameInfoMOTDScrollFrameScrollBar, 14, 5)
	GuildInfoFrameInfoMOTDScrollFrameScrollBar:ClearAllPoints()
	GuildInfoFrameInfoMOTDScrollFrameScrollBar:Point("TOPRIGHT", GuildInfoFrameInfoMOTDScrollFrame, 22, -13)
	GuildInfoFrameInfoMOTDScrollFrameScrollBar:Point("BOTTOMRIGHT", GuildInfoFrameInfoMOTDScrollFrame, 0, 8)
	...
	GuildInfoDetailsFrameScrollBar:Point("TOPRIGHT", GuildInfoDetailsFrame, 22, -14)
