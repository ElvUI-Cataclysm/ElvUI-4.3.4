...
elseif locale == "zhCN" then
	MSG_OUTDATED = "你的 %s 版本已经过期 (最新版本是 %s)。你可以从 https://github.com/ElvUI-Cataclysm/ 下载最新版本"
	HDR_CONFIG = "插件"
...
elseif locale == "zhTW" then
	MSG_OUTDATED = "你的 %s 版本已經過期 (最新版本為 %s)。你可以透過 https://github.com/ElvUI-Cataclysm/ 下載最新的版本"
	HDR_CONFIG = "插件"
