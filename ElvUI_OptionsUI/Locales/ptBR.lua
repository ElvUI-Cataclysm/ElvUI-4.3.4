...
L["Enemy Clickable Height"] = true
L["Enemy Clickable Width"] = true
...
L["Friendly Clickable Height"] = true
L["Friendly Clickable Width"] = true
...
L["ELVUI_DESC"] = "A |cffff7000E|r|cffe5e3e3lvUI|r é um Addon completo de substituição da interface original do World of Warcraft."
